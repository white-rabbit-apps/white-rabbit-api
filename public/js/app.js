...
app.config(function($locationProvider, $stateProvider, $urlRouterProvider, ParseProvider) {
  ...
  return Parse.initialize("IWr9xzTirLbjXH80mbTCtT9lWB73ggQe3PhA6nPg", "8iUoJovKQkhCcpOaMPZ3r9Ii3thLsuvLfHViXLrK");
});
...
app.factory('Breed', function(Parse) {
  ...
  return Breed = (function(_super) {
    ...
    Breed.configure("Breed", "name", "image", "description", "originCountry");
