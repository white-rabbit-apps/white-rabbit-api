...
function ParseServer(_ref) {
  ...
  var filesControllerAdapter = (0, _AdapterLoader.loadAdapter)(filesAdapter, _GridStoreAdapter.GridStoreAdapter);
  ...
  var filesController = new _FilesController.FilesController(filesControllerAdapter);
  var pushController = new _PushController.PushController(pushControllerAdapter);
  var loggerController = new _LoggerController.LoggerController(loggerControllerAdapter);
